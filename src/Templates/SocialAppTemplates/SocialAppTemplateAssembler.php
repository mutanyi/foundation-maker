...
namespace Evercode1\FoundationMaker\Templates\SocialAppTemplates;

use Evercode1\FoundationMaker\Builders\ContentRouters\ContentTraits\ReplacesTokens;

class SocialAppTemplateAssembler
{
    use ReplacesTokens;
    ...
    public function assembleTemplate($template)
    {
        ...
        if (file_exists(base_path(). '/app/Templates')){
            ...
            $file = base_path(). '/app/Templates/SocialAppTemplates/templates/' . $template . '.txt';
